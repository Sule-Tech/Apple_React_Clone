...
function YoutubeVideos() {
  ...
  useEffect(() => {
    fetch("https://www.googleapis.com/youtube/v3/search?key=AIzaSyCFACrHaAXGub2B7-6O9ydT3dj9wtmixKg&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=9")
      .then((response) => {
